...
int main() {
  ...
  items.push_back(Item("Boko Pencil", 10, 1.00));
  items.push_back(Item("TXST Shirt", 10, 25.00));
  items.push_back(Item("Boko Stuffed Animal", 10, 15.00));
  items.push_back(Item("TXST Lanyard", 10, 5.00));
  items.push_back(Item("TXST Football Jersey", 10, 75.00));
  ...
  string arr[] = { "Boko Pencil", "TXST Shirt", "Boko Stuffed Animal", "TXST Lanyard", "TXST Football Jersey"};
